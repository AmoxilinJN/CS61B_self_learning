...
//        BinaryTreeHelper(this.root,pre,in);
//    }
//
//    private void BinaryTreeHelper(TreeNode<T> temp,ArrayList<T> pre,ArrayList<T> in){
//
//        temp.item = pre.removeFirst();
//        in.remove(temp.item);
//        if (pre.getFirst() == in.getFirst()){
//            BinaryTreeHelper(temp.left,pre,in);
//        }
//        if (temp.right != null){
//            BinaryTreeHelper(temp.right,pre,in);
//        }
//        return;
//    }
    ...
    public int height() {
        ...
        return heightHelper(height,temp);
    }

    private int heightHelper(int height,TreeNode<T> temp){
        if (temp == null){
            return height;
        } else {
            height++;
            return Math.max(heightHelper(height,temp.left),heightHelper(height,temp.right));
        }
    ...
    public boolean isCompletelyBalanced() {
        ...
        return isCompletelyBalancedHelper(temp);
    }

    private boolean isCompletelyBalancedHelper(TreeNode<T> temp){
        if (temp.right == null && temp.left == null){
            return true;
        }
        if (temp.left != null && temp.right != null){
            return isCompletelyBalancedHelper(temp.left) && isCompletelyBalancedHelper(temp.right);
        }
        return false;
    }
    ...
    public static BinaryTree<Integer> fibTree(int N) {
        ...
        if (N == 0){
            ...
            result.root = fibTreeHelper(N,new TreeNode<>(0));
        }
        return result;
    }

    private static TreeNode<Integer> fibTreeHelper(int N,TreeNode<Integer> temp){
        if (N == 0 || N == 1){
            temp = new TreeNode<>(N);
            return temp;
        }
        ...
        temp.left = fibTreeHelper(N-1,temp.left);
        temp.right = fibTreeHelper(N-2,temp.right);
