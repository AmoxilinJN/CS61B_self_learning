...
public class SLListTest {
    ...
    public void testSLListReverse() {
        ...
        SLList l2=SLList.of(1);
        SLList l3=new SLList();
        l1.reverse();
        l2.reverse();
        l3.reverse();
        assertWithMessage("Wrong 1").that(l1).isEqualTo(SLList.of(5,4,3,2,1));
        assertWithMessage("Wrong 2").that(l2).isEqualTo(SLList.of(1));
        assertWithMessage("Wrong 3").that(l3).isEqualTo(new SLList());
    }
}
