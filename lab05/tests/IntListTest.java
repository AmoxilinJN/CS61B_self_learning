...
public class IntListTest {
    ...
    public void testCatenate() {
        // TODO: Add tests
        IntList L=IntList.of(1,2,3),J=IntList.of(4,5,6);
        assertWithMessage("Wrong first").that(IntList.catenate(L,J).equals(IntList.of(1,2,3,4,5,6))).isTrue();
    }
    ...
    public void testDCatenate() {
        // TODO: Add test
        IntList L=IntList.of(1,2,3),J=IntList.of(4,5,6);
        assertWithMessage("Wrong second").that(IntList.dcatenate(L,J)).isEqualTo(IntList.of(1,2,3,4,5,6));
    }
}
